...
<div id="radialtarget1" style="position:relative;">
    <div class="cols-sample-area">
         ...
         $ritemc1=new EJ\RadialMenu\Item();
         $ritemc1->imageUrl("Content/images/RadialMenu/f1.png")->text("Italic")->click("italic");
         $ritemc2=new EJ\RadialMenu\Item();
         $ritemc2->imageUrl("Content/images/RadialMenu/font.png")->text("Bold")->click("bold");
         $itemschild=array($ritemc1,$ritemc2);
         $ritem2->text("Bold")->click("bold")->imageUrl("Content/images/RadialMenu/font.png")->items($itemschild);
