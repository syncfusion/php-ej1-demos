...
<div class="cols-sample-area">
    ...
    ?>
    <div class="audi-q3">
        <img src="Content/images/dialog/audiq3-1.png"/>
        <br />
    ...
    <div class="cnt">
        It is a concept vehicle with Liquid Silver body colour, 20-inch wheels, fabric folding roof, electrically-controlled hood, 4-cylinder 2.0 TDI engine rated 204 PS (150 kW; 201 hp)
                            and 400 NÂ·m (295.02 lbfÂ·ft), diesel particulate filter and Bluetec emission control system, quattro permanent four-wheel drive system with Haldex clutch,
    ...
    <?php    
    echo $dialog->width("550px")->minHeight("215px")->minWidth("310px")->target(".cols-sample-area")->isResponsive(true)->close("onDialogClose")->templateEnd()->render();
