...
<div class="cols-sample-area">
    ...
    $context = new EJ\Grid\ContextMenuSetting();
    $context ->enableContextMenu(true);
	$toolbarItems = array("add","edit","delete","update","cancel");
    $toolbar= new EJ\Grid\ToolbarSetting(); 
   
    echo $grid -> allowPaging(true)->columns($gridColumns)->dataSource($Json)->editSettings($edit)->contextMenuSettings($context)->toolbarSettings($toolbar->showToolbar(true)->toolbarItems($toolbarItems))->render();
    ?>
